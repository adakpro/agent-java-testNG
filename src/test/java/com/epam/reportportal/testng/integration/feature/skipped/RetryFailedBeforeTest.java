...
public class RetryFailedBeforeTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(RetryFailedBeforeTest.class);
	...
	public void setUp() {
		throw new IllegalStateException("Inside @BeforeMethod setUp1 step");
	}
